...
class PedidoControllerIT {
    ...
    @Test
    void actualizarEstadoDevolucionValido() {
        ItemVentaRequest item = new ItemVentaRequest();
        item.setIdProducto(1L);
        item.setNombreProducto("Producto Devolucion Estado");
        item.setCantidad(1);
        item.setPrecioUnitario(1200.0);
        CrearVentaRequest ventaReq = new CrearVentaRequest();
        ventaReq.setIdCliente(20L);
        ventaReq.setMetodoPago(MetodoPago.EFECTIVO);
        ventaReq.setItems(List.of(item));
        Venta venta = ventaService.registrarVentaPresencial(ventaReq);
        CrearDevolucionRequest devReq = new CrearDevolucionRequest();
        devReq.setIdCliente(20L);
        devReq.setIdVenta(venta.getIdVenta());
        devReq.setMotivo("Producto defectuoso");
        Devolucion devolucion = devolucionService.crearDevolucion(devReq);
        Devolucion actualizada = devolucionService.actualizarEstadoDevolucion(
                devolucion.getIdDevolucion(), " aprobada ");
        assertEquals("APROBADA", actualizada.getEstado());
    }

    @Test
    void actualizarEstadoDevolucionInvalidoDebeFallar() {
        ItemVentaRequest item = new ItemVentaRequest();
        item.setIdProducto(2L);
        item.setNombreProducto("Producto Estado Invalido");
        item.setCantidad(1);
        item.setPrecioUnitario(1000.0);
        CrearVentaRequest ventaReq = new CrearVentaRequest();
        ventaReq.setIdCliente(21L);
        ventaReq.setMetodoPago(MetodoPago.EFECTIVO);
        ventaReq.setItems(List.of(item));
        Venta venta = ventaService.registrarVentaPresencial(ventaReq);
        CrearDevolucionRequest devReq = new CrearDevolucionRequest();
        devReq.setIdCliente(21L);
        devReq.setIdVenta(venta.getIdVenta());
    ...
    @Test
    void actualizarEstadoDevolucionNuloDebeFallar() {
        ItemVentaRequest item = new ItemVentaRequest();
        item.setIdProducto(3L);
        item.setNombreProducto("Producto Estado Nulo");
        item.setCantidad(1);
        item.setPrecioUnitario(900.0);
        CrearVentaRequest ventaReq = new CrearVentaRequest();
        ventaReq.setIdCliente(22L);
        ventaReq.setMetodoPago(MetodoPago.EFECTIVO);
        ventaReq.setItems(List.of(item));
        Venta venta = ventaService.registrarVentaPresencial(ventaReq);
        CrearDevolucionRequest devReq = new CrearDevolucionRequest();
        devReq.setIdCliente(22L);
        devReq.setIdVenta(venta.getIdVenta());
    ...
    @Test
    void actualizarEstadoReclamacionValido() {
        CrearPedidoRequest pedidoReq = new CrearPedidoRequest();
        pedidoReq.setMetodoPago(MetodoPago.EFECTIVO);
        Pedido pedido = pedidoService.crearDesdeCarrito(idCarritoActivo, pedidoReq);
        CrearReclamacionRequest recReq = new CrearReclamacionRequest();
        ...
        recReq.setIdPedido(pedido.getIdPedido());
        recReq.setMotivo("Pedido incompleto");
        recReq.setDescripcion("Faltaron productos del pedido");
        Reclamacion reclamacion = devolucionService.crearReclamacion(recReq);
        Reclamacion actualizada = devolucionService.actualizarEstadoReclamacion(
                reclamacion.getIdReclamacion(), " cerrada ");
        assertEquals("CERRADA", actualizada.getEstado());
    }

    @Test
    void actualizarEstadoReclamacionInvalidoDebeFallar() {
        CrearPedidoRequest pedidoReq = new CrearPedidoRequest();
        pedidoReq.setMetodoPago(MetodoPago.EFECTIVO);
        Pedido pedido = pedidoService.crearDesdeCarrito(idCarritoActivo, pedidoReq);
        CrearReclamacionRequest recReq = new CrearReclamacionRequest();
